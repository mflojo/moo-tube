...
export const videosRouter = createTRPCRouter({
    getManySubscribed: protectedProcedure
        ...
        .query(async ({ input, ctx }) => {
            ...
            const viewerSubscritions = db.$with("viewer_subscriptions").as(
                db
                    .select({
            ...
            .with(viewerSubscritions)
                ...
                .innerJoin(
                    viewerSubscritions,
                    eq(viewerSubscritions.userId, users.id)
                )
                .where(and(
    ...
    revalidate: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            ...
            //TODO: find a way to revalidate track status as well (maybe, its not needed)
